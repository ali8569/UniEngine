 ...
 */
package ir.markazandroid.UniEngine.sms;

import com.google.gson.*;
import ir.markazandroid.UniEngine.sms.enums.MessageType;
import ir.markazandroid.UniEngine.sms.exceptions.ApiException;
import ir.markazandroid.UniEngine.sms.exceptions.BaseException;
import ir.markazandroid.UniEngine.sms.exceptions.HttpException;
import ir.markazandroid.UniEngine.sms.models.*;
import ir.markazandroid.UniEngine.sms.utils.PairValue;
import ir.markazandroid.UniEngine.sms.utils.StringUtils;
...
public class KavenegarApi {
    ...
    private static final String API_PATH = "%s://api.kavenegar.com/v1/%s/%s.json";

    private String apiKey;
    private Boolean safe;

    public KavenegarApi(OkHttpClient client, String apiKey) {
        this.client = client;
        this.apiKey = apiKey;
        this.safe =Boolean.FALSE;
    }
	
    public KavenegarApi(OkHttpClient client, String apiKey, Boolean safe) {
        this.client = client;
        this.apiKey = apiKey;
        this.safe = safe;
    }
    ...
    public FormBody createParams(Object... params) {
        try {
    ...
    private JsonElement execute(String path, Object... params) throws BaseException {
        FormBody parameters = createParams(params);
