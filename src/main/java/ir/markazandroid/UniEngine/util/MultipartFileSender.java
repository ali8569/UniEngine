...
public class MultipartFileSender {
    ...
    public void serveResource() throws Exception {
        ...
        if (!Files.exists(filepath)) {
            logger.error("EFile doesn't exist at URI : {}", filepath.toAbsolutePath().toString());
        ...
        if (ifNoneMatch != null && HttpUtils.matches(ifNoneMatch, lastModified+"")) {
            response.setHeader("ETag", lastModified+""); // Required in 304.
        ...
        if (ifMatch != null && !HttpUtils.matches(ifMatch, lastModified+"")) {
